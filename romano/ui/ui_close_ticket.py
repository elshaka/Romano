...
"color: rgb(0, 170, 0);")
        ...
        self.outgoingWeightSpinBox.setProperty("value", 100000.0)
        ...
        self.weightsLayout.addItem(spacerItem)
        ...
        self.weightsLayout.addItem(spacerItem1)
        self.ticketFormLayout.setLayout(6, QtGui.QFormLayout.FieldRole, self.weightsLayout)
        ...
        self.clientButton = QtGui.QRadioButton(self.clientSelectWidget)
        self.clientButton.setEnabled(False)
        self.clientButton.setObjectName("clientButton")
        self.verticalLayout_2.addWidget(self.clientButton)
        self.factoryButton = QtGui.QRadioButton(self.clientSelectWidget)
        self.factoryButton.setEnabled(False)
        self.factoryButton.setObjectName("factoryButton")
        self.verticalLayout_2.addWidget(self.factoryButton)
        ...
        self.dialogLayout.addItem(spacerItem2)
        ...
        self.transactionsTotalLayout.addItem(spacerItem3)
